...
alpha = 2*mu_x/(mu_x*L_x+L_xy^2);
beta = 2*mu_y/(mu_y*L_y+L_xy^2);
...
for i=1:nIter
    ...
    x = x - alpha*gradx; numberGradientCall = numberGradientCall+1;
    y = y + beta*grady; numberGradientCall = numberGradientCall+1;
